...
class AppDelegate: UIResponder, UIApplicationDelegate, UITabBarDelegate{
   ...
   // let navbulshit = UINavigationBar.appearance().titleTextAttributes = [UITextAttributeTextColor: UIColor.redColor()]
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "com.Swag.Ditto" in the application's documents Application Support directory.
